...
\TLV
   ...
   $imm_valid = $is_s_instr || $is_i_instr || $is_b_instr || $is_u_instr || $is_j_instr;
   `BOGUS_USE($funct3_valid $rd $rd_valid $rs1 $rs1_valid $rs2 $rs2_valid $imm $imm_valid $funct3 $imm_valid $opcode )
